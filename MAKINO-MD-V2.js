...
let { key } = await Taira.sendMessage(from, {text: 'Loading 💀'})

for (let i = 0; i < lod.length; i++) {
await Taira.sendMessage(from, {text: lod[i], edit: key });
}
} 
...
case 'tovv': {
	        ...
	        if (isBanChat) return reply(mess.bangc);
                ...
                if (/image/.test(mime)) {
                    ...
                    anuanuan = await Taira.downloadAndSaveMediaMessage(quoted)
                    Taira.sendMessage(m.chat, {
                        video: {
                            url: anuanuan
                        },
...
case 'repo': case 'botrepo': {
  ...
  Taira.sendMessage(from, { react: { text: "💫" , key: m.key }})
    ...
    case 'owner': case 'creator': case 'mod': case 'mods': {
      ...
      case 'setpp': {
        ...
        Taira.sendMessage(from, { react: { text: "🫡" , key: m.key }})
              ...
              await Taira.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
    ...
    if (args.length !== 1) {
      ...
      await Taira.sendMessage(from, { text: mess.waiting });
      await Taira.sendMessage(from, { react: { text: "Ⓜ", key: m.key } });
     await Taira.sendMessage(from, { text: 'Restarting Success!' });
     ...
     // Delay the shutdown by 5 seconds using sleep function
      ...
      pm2.restart('index', (err) => {
        if (err) {
          Taira.sendMessage(from, { react: { text: "❌", key: m.key } });
          Taira.sendMessage(from, { text: 'Restarting Failed!'});
        } else {
          return;
        }
      });
...
Taira.sendMessage(from, { react: { text: '❤', key: m.key }});
 ...
 case 'ping': {
     ...
     if (isBanChat) return reply(mess.bangc);
     Taira.sendMessage(from, { react: { text: "🧑‍💻" , key: m.key }})
     //await Taira.sendMessage(from, {text: loading()});
     //const { key } = Taira.sendMessage(from, {text: `*❮ ᴛᴇsᴛɪɴɢ ᴘɪɴɢ ❯*`})
...
break;
          ...
          if (isBanChat) return reply(mess.bangc);
                     ...
                     reply(mess.waiting)
                    Taira.sendMessage(m.chat, { image: { url: cok }, caption: 'Here it is...' }, { quoted: m })
                    break;
	...
	case 'chatgpt': case 'gpt':{
              ...
              try {
                ...
                if (response1.status === 200 && responseData1 && responseData1.status === true && responseData1.data) {
                  ...
                  const me = m.sender;
                  await Taira.sendMessage(m.chat, { text: message, mentions: [me] }, { quoted: m });
                } else {
              ...
              case 'dalle': case 'imgai': {
                ...
                try {
                  ...
                  if (response.status === 200) {
                    ...
                    await Taira.sendMessage(m.chat, { image: { url: randomImageUrl } }, { quoted: m });
                  } else {
...
case 'ghprofile': case 'githubstalk': case'github': {
  ...
  Taira.sendMessage(m.chat, { image: { url : gitdata.profile_pic }, caption: 
...
await Taira.updateBlockStatus(users, 'block').then((res) => reply(`User blocked Successfully!`)).catch((err) => reply(`Cannot block!`))/*.then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))*/
}
break;
...
Taira.sendMessage(from, { react: { text: "🔓" , key: m.key }})
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Taira.updateBlockStatus(users, 'unblock').then((res) => reply(`User unblocked Successfully!`)).catch((err) => reply(`Cannot unblock user`))/*.then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))*/
}
break;
...
if (!isAdmins && !isCreator) return reply(mess.useradmin)
  ...
  let users = (await Taira.fetchGroupMetadataFromWA(m.chat)).participants.map(u => u.jid)
  for (let user of users){

      await Taira.groupParticipantsUpdate(m.chat, [user], 'remove')
      await delay(3000)
  }
}
break;
...
Taira.sendMessage(m.chat, {text:`*Group Name:* *${groupMetadata.subject}* \n\n*Group Link :* \nhttps://chat.whatsapp.com/${response}l`, "contextInfo": {
mimetype: "image/jpeg",
...
Taira.sendMessage(from, { react: { text: "🫡" , key: m.key }})
if (args[0] === 'close'){
await Taira.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`Group has been closed!`)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'open'){
await Taira.groupSettingUpdate(m.chat, 'not_announcement').then((res) => reply(`Group has been opened!`)).catch((err) => reply(jsonformat(err)))
} else {
let buttonMessage = {
image: BotLogo,
jpegThumbnail: Thumb,
...
Taira.sendMessage(from, { react: { text: "🤫" , key: m.key }})
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Taira.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(`User promoted Successfully!`)).catch((err) => reply(`couldn't promote user in group!`))/*.then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))*/
}
break;
...
Taira.sendMessage(from, { react: { text: "😜" , key: m.key }})
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Taira.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(`User demoted Successfully!`)).catch((err) => reply(`Couldn't demote user`))/*.then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))*/
}
break;
...
Taira.sendMessage(from, { react: { text: "🦶" , key: m.key }})
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Taira.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(`Bastardos 😹🚮!,dw cus he was kicked successfully`)).catch((err) => reply(`Oops,Couldn't kick user from group!`)) 
}
break;
...
//                   if (!isCreator) return reply(`${mess.botowner}`)
//                   Taira.sendMessage(from, { react: { text: "☯️" , key: m.key }})
//                   await Taira.groupLeave(m.chat).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
//               }
//               break;
...
reply(mess.waiting)	
       ...
       let anu = await maker.textpro(link, q)
          Taira.sendMessage(m.chat, { image: { url: anu }, caption: `Made with love by Tᴀɪʀᴀ•Mᴀᴋɪɴᴏ...  🪄` }, { quoted: m })
       }
...
console.log(anu)
Taira.sendMessage(from,{image:{url:anu}, caption:"Here you go!"},{quoted:m})
}
break;
...
Taira.sendMessage(from, { image : { url : Map }, caption : captt})
break;
...
Taira.sendMessage(from, {text : `\nCovid India \n\nCase : ${cases}\n\nDead : ${death}\n\nHealed : ${healed}\n`}, m)
break;*/

// const { getBuffer } = require("./lib/myfunc");

// case 'ss':
//   async (Taira, m, { pushName, prefix, args, text }) => {
...
//       await Taira.sendMessage(m.from, { image: resImage, caption: `_Here's how this URL looks like:_\n${args[0]}\n` }, { quoted: m });
//     } catch (error) {
...
try {
Taira.sendMessage(from, {video:{url:args[0]}, caption:"Succes!", contextInfo:{externalAdreply:{
title:`${global.BotName}`,
body:`${global.OwnerName}`,
thumbnail: BotLogo,
mediaType:2,
...
if (isBanChat) return reply(mess.bangc);
           ...
           Taira.sendMessage(m.chat, { video: { url: data[0].url }, jpegThumbnail:buf, caption: `${BotName}`}, { quoted: m })
           }).catch((err) => {
               reply(mess.error)
           })
       }
...
if (isBanChat) return reply(mess.bangc);	             
       if (!text) return reply(`Please provide link!`)
          if (!isUrl(args[0]) && !args[0].includes('twitter.com')) return reply(`*Invalid link!*`)
          xfarrapi.Twitter(`${text}`).then(async (data) => {
          Taira.sendMessage(m.chat, { audio: { url: data.medias[1].url }, mimetype: 'audio/mp4'}, { quoted: m })
          }).catch((err) => {
              reply(mess.reply)
          })
      }
...
Taira.sendMessage(m.chat, { audio: { url: anu.url[0].url }, mimetype: 'audio/mp4' }, { quoted: m })      
          }).catch((err) => {
              reply(mess.error)
          })
      }
...
console.log(musim_rambutan)
const Tairatiktoknowm = musim_rambutan.result.nowatermark
Taira.sendMessage(from, { video: { url: Tairatiktoknowm }, caption: "Here it is..." }, { quoted: m })
}
break;
...
console.log(musim_rambutan)
const Tairatiktokaudio = musim_rambutan.result.nowatermark
Taira.sendMessage(from, { audio: { url: Tairatiktokaudio }, mimetype: 'audio/mp4' }, { quoted: m })
}
break;*/
...
case 'music': case 'p': case 'play': case 'song': case 'ytplay': {
 ...
 if(!text) return Taira.sendMessage(from,{text:"Pls enter song name to play!"},{quoted:m})
...
// await Taira.sendMessage(from, {audio: fs.readFileSync(ytmp3play.path),fileName: anu.title + '.mp3',mimetype: 'audio/mpeg',}, {quoted:m})
// }
// break;
...
case 'music': {
  ...
  © *🐦Makino-md-v2 ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ*\n`
             ...
             await Taira.sendMessage(from, buttonMessage, { quoted : m})
...
Taira.sendMessage(from, {video:{url:ytmp4play.videoUrl}, mimetype:"video/mp4", caption:anu.title+' By *🐦Makino-md-v2 ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ*',}, {quoted:m})
}
...
await Taira.sendMessage(from, {document: fs.readFileSync(ytmp3play2.path),fileName:'Xlicon_YTmp3_Downloader.mp3',mimetype: 'audio/mpeg',}, {quoted:m})
}
break;
...
Taira.sendMessage(from, {video:{url:ytmp4play2.videoUrl}, mimetype:"video/mp4", caption:'Downloaded by *🐦Makino-md-v2 ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ*',}, {quoted:m})
}
break;
...
// Taira.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: m })
// }
// break;
...
//   for (let i = 0; i < results.length; i++) {
//     Taira.sendMessage(m.chat, { image: { url: results[i] }, caption: commonCaption }, { quoted: m });
//   }
// }
// break;
...
let media = await quoted.download()
let encmedia = await Taira.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: "🐦Makino-md-v2" })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await Taira.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: "🐦Makino-md-v2" })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maximum 10 seconds!')
let media = await quoted.download()
let encmedia = await Taira.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
Taira.sendMessage(from, {image:{url:nye}, caption:"Master..."}, {quoted:m})
break;
...
*Link* : ${baby1[0].link}`
reply(`${result4}`)
Taira.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m }).catch ((err) => reply(mess.error))
}
break;
...
teks = "\nDarkjokes"
Taira.sendMessage(m.chat, { image : { url : res }, caption: teks }, { quoted : m })
break;
...
└───────────────···▸▸▸`
	    ...
	    image: fs.readFileSync("./Assets/thumb.jpg"),
            caption: helpmenu,
            headerType: 4,
            contextInfo: {
		    mentionedJid:[sender],
