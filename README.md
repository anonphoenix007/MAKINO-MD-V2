...
2. Scan and Upload the `creds.json` to ***sessionDir*** Folder
    <br>
<a href='https://taira-tech-session.onrender.com/' target="_blank"><img alt='Get Session ID' src='https://img.shields.io/badge/Get-Session_ID-100000?style=for-the-badge&logo=scan&logoColor=white&labelColor=black&color=blue'/></a>
