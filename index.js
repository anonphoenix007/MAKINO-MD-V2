...
if (fs.existsSync(__dirname + '/sessionDir/creds.json')) {
  await fs.unlinkSync(__dirname + "/sessionDir/creds.json")}
    await fs.writeFileSync(__dirname + "/sessionDir/creds.json", cc, "utf8")
}
TairaSess()
